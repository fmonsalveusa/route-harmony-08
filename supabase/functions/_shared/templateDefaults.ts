...
export const AUTOMATIONS: AutomationDefinition[] = [
  ...
  {
    id: 'stop_docs',
    title: 'Gracias al driver por las fotos y el BOL/POD',
    description: 'Cuando el driver toca "PICK UP COMPLETED" o "DELIVERY COMPLETED" en la app, o tú envías esa parada al broker desde el TMS. Un mensaje por parada, al grupo del driver.',
    toggle: 'wa_stop_docs',
    templates: [
      {
        key: 'stop_docs_pickup',
        title: 'Pickup',
        description: 'Al completar un pickup.',
        body: 'Gracias {nombre}. Hemos recibido las fotos y el BOL del pick up en {ciudad}. Buen viaje.',
      ...
      },
      {
        ...
        title: 'Entrega',
        description: 'Al completar una entrega, incluida la última.',
        body: 'Gracias {nombre}. Hemos recibido las fotos y el POD de la entrega en {ciudad}. Buen viaje.',
