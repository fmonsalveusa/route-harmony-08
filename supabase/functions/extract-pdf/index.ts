        ...
        tools: [
          {
            ...
            input_schema: {
              ...
              properties: {
                ...
                needsTarp: {
                  type: "boolean",
                  description: "True if the document mentions that a tarp is required (e.g. 'tarp required', 'must tarp', 'needs tarp', 'tarping required', 'tarp load'). False otherwise.",
                },
              required: ["referenceNumber", "brokerClient", "totalRate", "weight", "stops", "needsTarp"],
            },
          },
        ],
...
TIME EXTRACTION: Look for pickup/delivery time windows, appointment times, or operating hours for each stop. Common formats: "08:00-15:00", "8 AM - 3 PM", "Appointment: 2:00 PM", "PU: 0800-1500", "FCFS" (First Come First Served), "Open 6A-4P". Return the time as shown in the document. If no time is found, use empty string.`,
    ...
    const result = {
      ...
      needsTarp:       extractedData.needsTarp      || false,
