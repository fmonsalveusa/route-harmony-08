...
const navItems: NavItem[] = [
  ...
  { label: 'Pagos Drivers', icon: DollarSign, path: '/payments/drivers', permission: 'payments.drivers' },
  { label: 'Pagos Investors', icon: CreditCard, path: '/payments/investors', permission: 'payments.investors' },
  { label: 'Pagos Dispatchers', icon: CreditCard, path: '/payments/dispatchers', permission: 'payments.dispatchers' },
