...
import {
  ...
  Headphones, Menu, Building2, Crown, CreditCard, Settings, Plus, Receipt, Trophy, Wrench, X
} from 'lucide-react';
    ...
    <div className="flex flex-col h-screen overflow-hidden bg-background">
      ...
      <header className="top-header flex items-center justify-between h-14 px-4 lg:px-6 safe-area-pt shrink-0">
        ...
        <div className="flex items-center gap-3">
          ...
          {hasPermission('loads') && (
            <Button size="sm" variant="secondary" onClick={() => setLoadDialogOpen(true)} className="gap-1 h-8 text-xs ml-3">
