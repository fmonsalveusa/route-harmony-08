...
const statusConfig: Record<string, { label: string; bg: string; text: string }> = {
  ...
  picked_up: { label: 'Picked Up', bg: '#d4e5f5', text: '#266aad' },
  on_site_delivery: { label: 'On Site - Delivery', bg: '#d4e5f5', text: '#266aad' },
...
export const DriversTimelineCard = ({ loads, drivers, trucks = [] }: Props) => {
  ...
  // Measure available width from the scroll wrapper (direct child of CardContent)
  useEffect(() => {
