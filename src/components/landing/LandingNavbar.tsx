...
const vehicles = [
  {
    ...
    details: "Nuestro servicio de dispatching para Box Trucks está diseñado para maximizar la eficiencia en rutas urbanas y regionales. Los Box Trucks son ideales para cargas secas, LTL y FTL, entregas de última milla y distribución local. Nuestro equipo conoce los mejores mercados y rutas para este tipo de vehículo.",
    cargas: [
      "Cargas secas (dry freight) — productos empacados, cajas, pallets",
      "Entregas de última milla para Amazon, FedEx, UPS Freight",
      "Mudanzas comerciales y residenciales",
    ...
    benefits: [
      "Tarifas promedio de $1.80 - $3.50 por milla",
      "Alta demanda en rutas urbanas y regionales",
